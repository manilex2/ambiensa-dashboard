...
@Component({
  ...
  templateUrl: '../views/detalle-proyecto.component.html',
  styleUrl: '../styles/detalle-proyecto.component.scss'
})
export class DetalleProyectoComponent {
  ...
  reportConfig: IReportEmbedConfiguration = {
    ...
    pageName: environment.powerbiConfig.ventasDetalleProyecto
  };
  ...
  async embedReport(): Promise<void> {
    try {
      ...
      .observe('(max-width: 768px)')
      .subscribe((state: BreakpointState) => {
        this.isMobile = state.matches;const reportUrl = environment.apiConfig.serverTokenUrl;
